...
def calculate_next_transits(start_time, dusk, dawn, number_of_transits, target, system):
    ...
    for i, (ingress, egress) in enumerate(filtered_transits):
        ...
        print(f"Transit {i+1} Midtime (MDT): {filtered_midtimes[i]}")
        ...
        print(f"Transit {i+1} Altitude: Ingress: {starting_alt:.{3}f}, Midtime: {starting_alt:.{3}f}, Egress: {ending_alt:.{3}f}")
