...
if __name__ == "__main__":
    ...
    bsu_obscoords =  [+43.590500",
        "Obs. Longitude": "-116.19]
    tres3_616_U_midtime = "2024-06-16 07:23:45"
    test = convert_times(time_data, tres3_objcoords, bsu_obscoords, format="", scale="")
    print(test)