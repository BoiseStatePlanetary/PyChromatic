...
def plot_next_transit():
    target, observabletransits = calculate_TrES3b_transits(Time('2024-10-01 18:00'), 10)
    for transit in observabletransits:
        # Create an array of observation times over the course of the transit
        obs_times = transit
        ...
        plt.plot(obs_times, altitudes, marker="o")
        plt.xlabel('Time (UTC)')
