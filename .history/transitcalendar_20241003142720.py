...
def calculate_HATP23b_transits(start_time, number_of_transits):
    ...
    fixed_target = create_target(RA=268.0291, DEC=37.54633, target_name="HAT-P-23b")
    HATP23b = create_eclipsingsystem(primary_eclipse_time=Time(2454185.9104, format="jd"), 
                                     orbital_period=1.30618581, 
                                     eclipse_duration=0.05907, 
