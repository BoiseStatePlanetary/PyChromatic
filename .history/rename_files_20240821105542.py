...
def rename_files(telescope_name=telescope_name, planet_name=planet_name)
...
if __name__ == '__main__':
    telescope_name = "melba"
    planet_name = "TrES-3b"
    rename_files(telescope_name, planet_name)
