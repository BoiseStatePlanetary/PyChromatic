...
def renormalize_data(PhotData, ingress_time):
      ...
      ingress_idx = np.argmin(np.abs(PhotData["BJD_TDB"]-ingress_time))  # note this number is specific to 6/15 transit
...
if __name__ == "__main__":
    ...
    ingressT = 2460477.78
    renormalize_data(photdata, ingress)