...
def rename_files():
    ...
    my_files = [(file, os.path.join(dir, file)) for file in os.listdir(dir) if os.path.isfile(os.path.join(dir, file)) and os.path.splitext(file) == ".fits"]
    fits_mask = os.path.splitext(my_files)
    ...
    telescope_name = str(input("Enter Telescope Name: "))
