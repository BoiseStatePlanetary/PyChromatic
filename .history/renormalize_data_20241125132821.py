...
def renormalize_data(PhotData, ingress_time):
      ...
      normalized_b_flux = PhotData["flux"]/median_b_flux
      ...
      normalized_flux = np.vstack((normalized_b_flux, normalized_flux_after))
      PhotData["normalized_flux"] = np.concatenate((normalized_b_flux, normalized_flux_after))
      return PhotData
